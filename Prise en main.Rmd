...
map <- mapview(commune, layer.name = "Communes", col.regions = "white", alpha.regions = 0.5) +
  ...
  mapview(apres_geom, layer.name = "Parcelles modifiées (2024)", col.regions = "purple", alpha.regions = 0.5) +
  mapview(avant_geom, layer.name = "Parcelles modifiées (2023)", col.regions = "pink", alpha.regions = 0.5) +
