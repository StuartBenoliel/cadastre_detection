...
```{r}
mapview_map <- mapview(commune_get, layer.name = "Communes", col.regions = "white", alpha.regions = 0.5) +
  mapview(extended_borders, layer.name = "Bordures étendues", col.regions = "lightblue", alpha.regions = 0.5) +
  mapview(intersected_parcelles, layer.name = "Parcelles croisées", col.regions = "purple", alpha.regions = 0.5)
mapview_map
```
