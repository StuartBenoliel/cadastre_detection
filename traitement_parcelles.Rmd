...
ajout <-dbGetQuery(conn, paste0("
  ...
  FROM 
      parc_", params$num_departement, "_", params$temps_avant, " avant
  JOIN 
      parc_", params$num_departement, "_", params$temps_apres," apres
  ON 
      ST_Intersects(avant.geometry, apres.geometry) AND avant.geometry && apres.geometry ;"))
```
