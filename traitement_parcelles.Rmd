...
dbExecute(conn, paste0("
  ...
  WHERE EXISTS (
      ...
      FROM parc_", params$num_departement, "_", params$temps_avant, " avant
      WHERE apres.idu = avant.idu 
      AND apres.contenance = avant.contenance
  );"))
...
dbExecute(conn, paste0("
  ...
  WHERE EXISTS (
      ...
      FROM parc_", params$num_departement, "_", params$temps_avant, " avant
      WHERE apres.idu = avant.idu 
      AND ST_IsValid(ST_SnapToGrid(apres.geometry, 0.0001))
      AND ST_IsValid(ST_SnapToGrid(avant.geometry, 0.0001))
      AND ST_Equals(
...
mapshot(map, url = paste0("www/parcelles_modifiés_",params$num_departement,"_",params$temps_apres,"-",params$temps_avant,".html"))
```
...
dbExecute(conn, "
  ...
  WHERE idu IN 
      (SELECT ajout_simp.idu FROM ajout_simp
        ...
        WHERE ST_IsValid(ajout_simp.geometry) AND ST_IsValid(supp_simp.geometry));
")
...
mapshot(map, url = paste0("www/parcelles_restantes_",params$num_departement,"_",params$temps_apres,"-",params$temps_avant,".html"))
```
...
dbExecute(conn, "
  ...
  ajout_iou_translate, supp_iou_multi, ajout_simp, supp_simp,
...
mapshot(map, url = paste0("www/parcelles_",params$num_departement,"_",params$temps_apres,"-",params$temps_avant,".html"))
```
