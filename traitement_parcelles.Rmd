...
ins_parc_avant <- st_read(conn, query = paste0("SELECT * FROM ", 
                                               ifelse(indic_bordure, 
                                                      'ins_parc_avant;', 
                                                      paste0("parc_", params$num_departement, "_", params$temps_avant, ";"))))

ins_parc_apres <- st_read(conn, query = paste0("SELECT * FROM ", 
                                               ifelse(indic_bordure, 
                                                      'ins_parc_apres;', 
                                                      paste0("parc_", params$num_departement, "_", params$temps_apres, ";"))))
```
...
bordure <- st_read(conn, query = "SELECT * FROM bordure;")
ins_parc_avant <- st_read(conn, query = paste0("SELECT * FROM parc_", params$num_departement, "_", params$temps_avant, ";"))
ins_parc_apres <- st_read(conn, query = paste0("SELECT * FROM parc_", params$num_departement, "_", params$temps_apres, ";"))
