...
dbExecute(conn, "
  ...
  SELECT supp.idu, supp.nom_com, supp.code_com, supp.com_abs, supp.contenance, 
      ajout.iou_ajust, supp.idu, ajout.idu, supp.geometry
  FROM supp 
  INNER JOIN ajout ON ajout.idu_translate = supp.idu
  WHERE ajout.iou_ajust >= 0.95 
      AND ajout.idu_translate NOT IN (
          SELECT idu_translate FROM ids_to_exclude
  );")
# DOUBLON ! Key (idu)=(783210000A3069) 78 pour les années 2022 - 2021
