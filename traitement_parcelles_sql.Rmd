...
dbExecute(conn, paste0("
  ...
  WHERE avant.nom_com IN (SELECT nom_com FROM parc_", num_departement, "_", temps_apres,");"))
...
dbExecute(conn, paste0("
  ...
  FROM
      avant
  JOIN ajout ON ajout.idu LIKE avant.prefix_idu || '___' || avant.suffix_idu
  WHERE avant.nom_com NOT IN (SELECT nom_com FROM parc_", num_departement, "_", temps_apres,");"))
