...
plot <- ggplot() +
  ...
  theme_minimal() +
  labs(title = "Parcelles cadastrales (2024) croisant les frontières étendues des communes de Côte d'or", 
       fill ="Légende",
...
plot <- ggplot() +
  ...
  theme_minimal() +
  labs(title = "Parcelles cadastrales croisant les frontières étendues des communes en Côte d'or, modifiés au niveau de la geometry en 2024", 
       fill ="Légende",
       subtitle = "Les bordures des communes sont élargies d'un rayon de 50m de chaque côté de celles définies par l'IGN")
