...
```{r iou ajout/sup -> fusion/subdivision}
...
```{r iou_multi -> multi-subdivision  et contours}
...
map <- mapview(commune, layer.name = "Communes", col.regions = "white", 
  ...
  mapview(modif_avant, z = c("iou_ajust"), 
          ...
          alpha.regions = 0.5, homebutton = F) +
  mapview(translation, z = c("iou_ajust"), 
  ...
  mapview(ajout, z = c("iou"), layer.name = "Parcelles restantes (état 2024)", 
          alpha.regions = 0.5, homebutton = F) +
  mapview(supp, z = c("iou"), layer.name = "Parcelles restantes (état 2023)", 
          alpha.regions = 0.5, homebutton = F)
