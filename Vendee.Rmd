...
map <- mapview(commune, layer.name = "Communes", col.regions = "white", alpha.regions = 0.5,
  ...
  mapview(bordure, layer.name = "Bordures étendues", col.regions = "lightblue", alpha.regions = 0.5,
          homebutton = F) +
  mapview(apres_geom,
          z=c("iou_ajust"), layer.name = "Parcelles modifiées iou < Q_10% = 0.953 (état 2024)", 
          alpha.regions = 0.5,
          homebutton = F) +
  mapview(avant_geom, 
          z=c("iou_ajust"), layer.name = "Parcelles modifiées iou < Q_10% = 0.953 (état 2023)", 
          alpha.regions = 0.5,
          homebutton = F) +
  mapview(translation_apres,
          z=c("iou_ajust"), layer.name = "Parcelles peu modifiées iou > Q_5% = 0.934 (état 2024)", 
          alpha.regions = 0.5,
          homebutton = F) +
  mapview(inter_parc_23 %>%
            filter(idu %in% translation_apres$idu_translate), 
          layer.name = "Parcelles peu modifiées iou > Q_5% = 0.934 (état 2023)", 
          alpha.regions = 0.5,
          homebutton = F) +
