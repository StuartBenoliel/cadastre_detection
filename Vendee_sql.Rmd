...
```{r}
dbExecute(conn, "
  CREATE TEMP TABLE modif_apres_jointure_multi AS
  SELECT modif_apres_jointure.*, 
    (calcul_iou_multi(modif_apres_jointure.geometry, 'modif_apres_jointure' , 'modif_avant_jointure')).*
  FROM modif_apres_jointure;
")
...
dbExecute(conn, "
  ...
  FROM modif_apres_jointure_multi
...
dbExecute(conn, "
  DELETE FROM modif_apres_jointure_multi
...
modif_apres_sql <- st_read(conn, query = "SELECT * FROM modif_apres_jointure_multi;")

modif_avant_sql <- st_read(conn, query = "SELECT * FROM modif_avant_jointure;")
```
