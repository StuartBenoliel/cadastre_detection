...
dbExecute(conn, "CREATE INDEX IF NOT EXISTS idx_ins_parc_24_geometry ON ins_parc_24 USING GIST(geometry);")
dbExecute(conn, "CREATE INDEX IF NOT EXISTS idx_ins_parc_23_geometry ON ins_parc_23 USING GIST(geometry);")
